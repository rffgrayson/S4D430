 CLASS zcl_arf_structure DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_ARF_STRUCTURE IMPLEMENTATION.
...
* Task 1
**********************************************************************
    DATA address TYPE zarfs_address.
...
* Task 2
**********************************************************************
    DATA person2 TYPE zarfs_person_inc.
