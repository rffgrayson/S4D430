CLASS zcl_arf_table_type DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_ARF_TABLE_TYPE IMPLEMENTATION.
...
*    DATA addresses TYPE tt_addresses.
    DATA addresses TYPE zarft_addresses.
...
*    DATA person TYPE st_person_deep.
    DATA person TYPE zarfs_person_deep.
...
*    DATA persons TYPE tt_persons.
    DATA persons TYPE zarft_persons.
